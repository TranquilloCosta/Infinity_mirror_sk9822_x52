...
int16_t sat1 = 255;
int16_t val1 = 255;
int16_t brightness1 = 90; // Set initial animations brightness (max. value 255, recommended 90)
int16_t brightness_w = 90; // Set initial plain white brightness (max. value 255, recommended 90)
int current_color = 1;
int pause = 0;
int active = 0;
